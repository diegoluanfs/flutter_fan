...
class Fan6Page extends StatefulWidget {
  const Fan6Page({super.key});

  @override
  State<Fan6Page> createState() => _Fan6PageState();
}

class _Fan6PageState extends State<Fan6Page>
  ...
  Future<void> _setupAudio() async {
    await _audioPlayer.setAsset('assets/sounds/6-fan.mp3');
