...
class Fan4Page extends StatefulWidget {
  const Fan4Page({super.key});

  @override
  State<Fan4Page> createState() => _Fan4PageState();
}

class _Fan4PageState extends State<Fan4Page>
  ...
  Future<void> _setupAudio() async {
    await _audioPlayer.setAsset('assets/sounds/4-fan.mp3');
