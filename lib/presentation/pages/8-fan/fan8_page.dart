...
class Fan8Page extends StatefulWidget {
  const Fan8Page({super.key});

  @override
  State<Fan8Page> createState() => _Fan8PageState();
}

class _Fan8PageState extends State<Fan8Page>
  ...
  Future<void> _setupAudio() async {
    await _audioPlayer.setAsset('assets/sounds/8-fan.mp3');
